...
class AddAirplaneForm(forms.Form):
    ...
    ip_locationID = forms.CharField(max_length=100, label="Location")
...
class OfferFlightForm(forms.Form):
    ...
    ip_support_tail = forms.CharField(max_length=50, label="Support Tail")
    ...
    ip_next_time = forms.CharField(max_length=50, label="Next Time")
